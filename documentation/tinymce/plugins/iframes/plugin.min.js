...
tinymce.PluginManager.add('iframes', function(editor, url) {
	var urlPatterns = [
		...
		if (data.embed) {
			...
			if (data.type == "iframe") {
				...
				if (editor.settings.video_template_callback) {
					...
					html = (
						'<iframe src="' + data.source1 + '" width="' + data.width + '" height="' + data.height + '" allowfullscreen frameborder="0"></iframe>'
					);
				}
			}
		}
